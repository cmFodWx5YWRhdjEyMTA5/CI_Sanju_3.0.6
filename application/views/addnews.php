...
<?php echo form_open_multipart("user/addnews",['class'=>'form-horizontal']); ?>
                                    <br>
							<?php 
...
echo form_error('NewsTitle'); ?>
									<br>
<?php 
echo form_textarea(['name'=>'NewsDtl','class'=>'form-control ckeditor','placeholder'=>'न्यूज़ का विवरण','value'=>set_value('NewsDtl'),'cols' => 40, 'rows' => 4]); 
