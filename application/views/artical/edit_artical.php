...
<?php 
  echo form_open_multipart("admin/artical/update_artical/{$Art_Val->Art_Id}",['class'=>'form-horizontal']);
            ...
            <div class="panel panel-default">
                                ...
                                <div class="panel-body">  
                                	<div class="panel-body">  
                                            ...
                                            <label class="col-md-3 col-xs-12 control-label">आर्टिकल का पुराना फोटो</label>
                                            <div class="col-md-6 col-xs-12">
                                            <img width="200" height="150" src="<?php echo base_url('uploads/Artical_Pic/Artical_Thumb/'.$Art_Val->Artical_Thumb) ?>">
                                            </div>
                                        </div>                                                                      
                					</div> 
									<div class="panel-body">  
