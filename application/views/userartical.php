<?php 
$pagetitle = $this->session->userdata('UserName').' '.'के द्वारा पोस्ट आर्टिकलो की लिस्ट';
...
$(document).ready(function() {
	...
	<section class="post-wrapper-top jt-shadow clearfix">
		<div class="container">
			<div class="col-lg-12">
				<h2><?php echo $this->session->userdata('UserName').' '.'के द्वारा पोस्ट आर्टिकलो की लिस्ट';?></h2>
			...
			<div class="shop_wrapper col-lg-12 col-md-9 col-sm-12 col-xs-12" style="float:left;">
                ...
                <table class="cart_table table table-hover">
                    ...
                    <tr>
                      <th width="17">क्र.</th>
                      <th width="70">फोटो</th>
                      <th width="119">आर्टिकल का नाम</th>
                  ...
                  <tbody>
                  	<?php
						if(is_array($User_Artical) and count($User_Artical)>0){
							$count = $this->uri->segment(3);
							
							foreach($User_Artical as $ArtVal){
					?>
                    <tr>
                      <td><?php echo ++$count; ?></td>
                      <td>
                      	 	<?php 
							if($ArtVal->Artical_Thumb =='')
							{ //$res['NewsTitle']
						?>
			<img class="img-responsive alignleft" width="65" src="<?php echo base_url('uploads/no-news.png')?>" >
            					<?php }else{ ?>
			<img  class="img-responsive alignleft" width="65" src="<?php echo base_url('uploads/Artical_Pic/Artical_Thumb/'.$ArtVal->Artical_Thumb)?>" width="330" height="185"/>
            					<? }?>	
                       </td>
                      <td><?php echo substr($ArtVal->Artical_Title,0,52).' ...';?></td>
                      <td>
					  		<?php 
								echo substr($ArtVal->Artical_Dtl,0,100).' ...';
							?>
                       </td>
                      <td><?php echo $ArtVal->Active?></td>
                      <td><?php echo date("d M Y", strtotime($ArtVal->Post_Date))?></td>
  ...
  <tr>
    <td>
<?= anchor("user/editArt/{$ArtVal->Art_Id}",'Edit',['class'=>'btn btn-primary','style'=>'margin-top:14px;']);?>
			...
			<div id="" class="col-lg-3 col-md-4 col-sm-12 col-xs-12" style="">
                <div class="widget">
                    ...
                    <ul class="nav nav-tabs nav-stacked">
                        ...
                        <li id="userartical"><a href="<?php echo base_url('user/userartical')?>">आर्टिकल की लिस्ट</a></li>
