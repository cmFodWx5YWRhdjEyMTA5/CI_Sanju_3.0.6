<?php 
$pagetitle = $this->session->userdata('UserName').' '.'के द्वारा पोस्ट न्यूज़ की लिस्ट';
...
$(document).ready(function() {
		 ...
		 // document.getElementById("newsList").innerHTML = "एडिट न्यूज़";
    ...
    <section class="blog-wrapper">
    	<div class="container">
			...
			<div class="shop_wrapper col-lg-12 col-md-9 col-sm-12 col-xs-12" style="float:left;">
                ...
                <table class="cart_table table table-hover">
                    ...
                    <tr>
                      <th width="17">क्र.</th>
                      <th width="70">फोटो</th>
                      <th width="119">न्यूज़ का नाम</th>
                      <th width="112">न्यूज़ का विवरण</th>
                  ...
                  <tbody>
                  	<?php
						if(is_array($User_News) and count($User_News)>0){
							$count = $this->uri->segment(3);
							
							foreach($User_News as $NewsVal){
					?>
                    <tr>
			...
			<img class="img-responsive alignleft" width="65" src="<?php echo base_url('uploads/no-news.png')?>" >
            					<?php }else{ ?>
			<img  class="img-responsive alignleft" width="65" src="<?php echo base_url('uploads/NewsPic/News_Thumb/'.$NewsVal->News_Thumb)?>" width="330" height="185"/>
            					<? }?>	
                       </td>
                      <td><?php echo substr($NewsVal->NewsTitle,0,52).' ...';?></td>
                      <td>
					  		<?php 
								echo substr($NewsVal->NewsDtl,0,100).' ...';
							?>
                       </td>
                      <td><?php echo $NewsVal->Active?></td>
                      <td><?php echo date("d M Y", strtotime($NewsVal->Post_Date))?></td>
  ...
  <tr>
    <td>
<?= anchor("user/editnews/{$NewsVal->News_Id}",'Edit',['class'=>'btn btn-primary','style'=>'margin-top:14px;']);?>
