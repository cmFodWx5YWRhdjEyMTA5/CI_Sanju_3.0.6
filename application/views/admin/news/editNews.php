...
<?php 
  echo form_open_multipart("admin/news/editNews/{$NewsVal->News_Id}",['class'=>'form-horizontal']);
                                ...
                                <div class="panel-body">  
									...
									<div class="panel-body">  
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">न्यूज़ का करंट फोटो</label>
                                            <div class="col-md-6 col-xs-12">
                                                <?php 
                                	if($NewsVal->News_Thumb =='')
                                	{
                                ?>
				                <img width="70" height="70" src="<?=base_url('uploads/no-image.jpg')?>" >
            					<?php }else{ ?>
               <img width="200" height="200" src="<?=base_url('uploads/NewsPic/News_Thumb/'.$NewsVal->News_Thumb)?>" style=""/>
        	   					<?php }?> 
												<?php echo br('2');
												echo "<label class='control-label'>न्यूज़ का नया फोटो</label>";
...
<?php echo form_textarea(['name'=>'NewsDtl','class'=>'form-control ckeditor','placeholder'=>'न्यूज़ का विवरण','value'=>set_value('NewsDtl', $NewsVal->NewsDtl),'cols' => 40, 'rows' => 4]); 
...
<?php 
  ...
  echo form_dropdown('Active', $Act_Val, set_value('Active',$NewsVal->Active),'class="form-control" ');
//echo form_dropdown('Video_Cat', $Cat_Val, set_value('Video_Cat', $VdiVal->Video_Cat),'class="form-control" ');
...
<button type="button" onclick="Javascript:window.location.href='<?=base_url('admin/news/index')?>';" class="btn btn-default pull-right">Back To News</button>  
