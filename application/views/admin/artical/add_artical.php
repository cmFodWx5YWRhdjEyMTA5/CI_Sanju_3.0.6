<?php 
$pagetitle = 'न्यू आर्टिकल का विवरण';
...
<?php echo form_open_multipart('admin/artical/add_artical',['class'=>'form-horizontal'])?>

            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>न्यू आर्टिकल का विवरण</strong></h3>
