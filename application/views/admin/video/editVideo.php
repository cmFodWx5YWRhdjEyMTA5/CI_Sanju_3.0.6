<?php 
$pagetitle = '( '.$VdiVal->Video_Name.' )'.' वीडियो का विवरण';
...
<?php 
  echo form_open_multipart("admin/video/editVideo/{$VdiVal->Video_Id}",['class'=>'form-horizontal']);
...
<?php echo form_input(['name'=>'Video_Name','class'=>'form-control','placeholder'=>'वीडियो का नाम','value'=>set_value('Video_Name',$VdiVal->Video_Name)]); 
...
echo form_input(['name'=>'Video_Link','class'=>'form-control','placeholder'=>'वीडियो का लिंक','value'=>set_value('Video_Link',$VdiVal->Video_Link)]);
...
<?php echo form_textarea(['name'=>'Video_Dtl','class'=>'form-control ckeditor','placeholder'=>'वीडियो का विवरण','value'=>set_value('Video_Dtl',$VdiVal->Video_Dtl),'cols' => 40, 'rows' => 4]); 
...
echo form_dropdown('Active', $Act_Val, set_value('Active', $VdiVal->Active),'class="form-control" ');
