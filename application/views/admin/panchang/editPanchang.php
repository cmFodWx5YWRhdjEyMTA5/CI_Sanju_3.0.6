...
$pagetitleVal =	'आज का पंचांग एडिट करे';
...
<?php 
	echo form_open_multipart("admin/panchang/editPanchang/{$PanchangVal->panchang_id}",['class'=>'form-horizontal']);
?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">  
                    ...
                    <div class="form-group">
                        <label class="col-md-3 col-xs-12 control-label">आज का पंचांग भरे</label>
                        <div class="col-md-6 col-xs-12">                                            
                            <div class="input-group">
                                <span class="input-group-addon">@</span>
<?php 
echo form_textarea(['name'=>'panchang_dtl','class'=>'form-control ckeditor','placeholder'=>'आज का पंचांग भरे','value'=>set_value('panchang_dtl', $PanchangVal->panchang_dtl),'cols' => 40, 'rows' => 4]); 
echo form_error('panchang_dtl'); 
?>
                            </div>                                            
                        </div>
                    </div>
...
echo form_dropdown('Active', $Act_Val, set_value('Active',$PanchangVal->Active),'class="form-control" ');
