...
<?php 
	echo form_open_multipart("admin/websys/editSlider/{$Slide_Val->Slide_Id}",['class'=>'form-horizontal']);
?>
...
<?php 
echo form_textarea(['name'=>'Slider_Text','class'=>'ckeditor form-control','placeholder'=>'स्लाइडर के बारे में भरे','value'=>set_value('Slider_Text', $Slide_Val->Slider_Text),'cols' => 40, 'rows' => 4]); 
...
echo form_dropdown('Active', $Act_Val, set_value('Active',$Slide_Val->Active),'class="form-control" ');
