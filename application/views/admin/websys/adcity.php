...
<?php 
	echo form_open_multipart("admin/websys/adCity",['class'=>'form-horizontal']);
?>
...
<?php echo form_input(['name'=>'CityName','class'=>'form-control','placeholder'=>'शहर का नाम','value'=>set_value('CityName')]); 
...
?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">                                            
                            <div class="input-group">
                                <span class="input-group-addon">@</span>
<?php echo form_input(['name'=>'EngName','class'=>'form-control','placeholder'=>'शहर के अंग्रजी नाम','value'=>set_value('EngName')]); 
