...
<?php 
	echo form_open_multipart("admin/websys/storeSlider",['class'=>'form-horizontal']);
?>
                ...
                <div class="panel-body">  
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <?php 
								echo form_upload(['name'=>'Slider_Img']);
...
<?php 
 echo form_textarea(['name'=>'Slider_Text','class'=>'form-control','placeholder'=>'स्लाइडर के बारे में भरे','value'=>set_value('Slider_Text'),'cols' => 40, 'rows' => 4]); 
