...
<?php echo form_open_multipart('admin/temple/add',['class'=>'form-horizontal'])?>
                                    ...
                                    <div class="panel-body">  
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <?php 
                                                    echo form_upload(['name'=>'Temp_Img']); 
                                                ?>
                                                <div class="red-left">
...
<?php 
echo form_input(['name'=>'Temp_Name','class'=>'form-control','placeholder'=>'मंदिर का नाम','value'=>set_value('Temp_Name')]); 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"></span>
<?php
echo form_input(['name'=>'VillageName','class'=>'form-control','placeholder'=>'गॉव का नाम','value'=>set_value('VillageName')]); 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"></span>
<?
echo form_dropdown('Dist_Name', $dropdown, set_value('Dist_Name'),'class="form-control"');
...
<?php echo form_textarea(['name'=>'Temp_Dtl','class'=>'form-control ckeditor','placeholder'=>'मंदिर का विवरण','value'=>set_value('Temp_Dtl'),'cols' => 40, 'rows' => 4]); 
