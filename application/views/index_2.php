...
<div class="slider-wrapper">
		...
		<img src="<?php echo DEMO_IMG?>sliderbg_04.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
		            </li>
        			<?php }else{ ?>
                    
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" style="max-height:500px;">
                        <img  src="<?=base_url('uploads/Slider_Pic/Slider_Thumb/'.$res->Slider_Thumb)?>"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <div class="tp-caption high_title2 customin customout start"
                            ...
                            data-endspeed="300" style="color:#FFF; font-weight:bold; "><?php echo $res->Slider_Text; ?>
                        </div>
                        <div class="tp-caption light_title customin customout start"
                            ...
                            data-start="700"
                            data-easing="Back.easeInOut"
                            data-endspeed="300"><?php //echo $res->Slider_Text; ?>
                        </div>
...
<?= anchor("index/viewmeb/{$res->Main_Id}", $res->Main_Person ,['class'=>'']);?>
           ...
           <div id="sidebar" class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			...
			<img width="490" height="249" class="img-responsive"  src="<?=base_url('uploads/no-news.png')?>" >
            					<?php }else{ ?>
			<img  class="" src="<?php echo base_url('News_Pic/News_Thumb/'.$res->News_Thumb)?>" width="330" height="185"/>
            					<? }?>
                                <div class="magnifier">
                                    <div class="buttons">
		<a class="st" rel="bookmark" href="<? echo base_url('index/news/News_Id/'.$res->News_Id)?>"><i class="fa fa-link"></i></a>
                                    </div><!-- end buttons -->
                                </div><!-- end magnifier -->
                                <div class="post-type">
                            ...
                            <div class="blog-carousel-header">
                                <h3>
		<a title="<? echo $res->NewsTitle ; ?>" href="<? echo base_url('index/news/News_Id/'.$res->News_Id)?>"><? echo $res->NewsTitle ; ?></a>
                                </h3>
